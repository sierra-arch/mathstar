  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <Link
          href="/get"
          className="text-sm font-semibold bg-[#7030A0] text-white px-5 py-2.5 rounded-full hover:bg-[#5A2080] transition-colors"
        >
          Get MathSTAR
        </Link>
      </div>
      ...
      <Link
        href="/get"
        className="md:hidden text-sm font-semibold bg-[#7030A0] text-white px-4 py-2 rounded-full hover:bg-[#5A2080] transition-colors"
      >
        Get Started
      </Link>
    </motion.nav>

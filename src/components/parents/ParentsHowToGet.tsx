...
export default function ParentsHowToGet() {
  return (
    <section className="relative py-40 px-6 lg:px-16 bg-white overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(252,165,165,0.42) 0%, rgba(220,38,38,0.13) 42%, transparent 68%)" }} />
      ...
      <div className="absolute -bottom-16 -right-16 w-[420px] h-[420px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(127,29,29,0.18) 0%, transparent 62%)" }} />
      <div className="absolute top-0 right-1/3 w-[380px] h-[380px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(254,242,242,0.85) 0%, transparent 65%)" }} />
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          >
            Two easy ways to{" "}
            <em className="not-italic italic text-[#DC2626]">get started</em>
          </motion.h2>
        </div>
            ...
            >
              ...
              <div className="p-10 flex flex-col flex-1">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-[#DC2626] font-semibold text-base hover:gap-4 transition-all"
                >
                  {o.cta}
                </Link>
              </div>

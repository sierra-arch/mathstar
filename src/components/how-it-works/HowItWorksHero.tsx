  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute top-[-8%] right-[-5%] w-[700px] h-[700px] rounded-full blur-[90px]"
          style={{ background: "radial-gradient(circle, rgba(196,159,220,0.35) 0%, rgba(112,48,160,0.06) 55%, transparent 75%)" }}
        />
        <div
          className="absolute bottom-[-10%] left-[-5%] w-[550px] h-[550px] rounded-full blur-[80px]"
          style={{ background: "radial-gradient(circle, rgba(8,145,178,0.18) 0%, transparent 65%)" }}
        />
        <div
          className="absolute top-[30%] left-[-8%] w-[500px] h-[500px] rounded-full blur-[100px]"
          style={{ background: "radial-gradient(circle, rgba(196,159,220,0.28) 0%, transparent 70%)" }}
        />
      </div>
      ...
      >
        <div className="max-w-4xl">
          ...
          <motion.h1
            className="text-5xl sm:text-6xl lg:text-[5.5rem] xl:text-[6.5rem] font-extrabold text-[#0D0B12] leading-[1.0] mb-8"
          ...
          >
            {stats.map((s, i) => (
              <div key={i} className="border-t-2 border-[#7030A0]/20 pt-5 min-w-[140px]">
                <div

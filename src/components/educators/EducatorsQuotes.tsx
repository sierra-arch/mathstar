...
export default function EducatorsQuotes() {
  return (
    <section className="relative py-40 px-6 lg:px-16 bg-white overflow-hidden">
      ...
      <div className="absolute -bottom-16 -left-16 w-[430px] h-[430px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(74,30,107,0.18) 0%, transparent 62%)" }} />
      <div className="absolute top-0 left-1/3 w-[400px] h-[400px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(240,230,247,0.88) 0%, transparent 65%)" }} />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {quotes.map((q, i) => (
            <motion.div
              key={i}
              className="bg-[#F7F2FF] rounded-3xl p-8 flex flex-col border border-[#7030A0]/8"

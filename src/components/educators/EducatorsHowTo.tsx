...
export default function EducatorsHowTo() {
  return (
    <section className="relative py-40 px-6 lg:px-16 bg-[#FFF5F5] overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[950px] h-[950px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(252,165,165,0.46) 0%, rgba(220,38,38,0.15) 42%, transparent 68%)" }} />
      ...
      <div className="absolute -bottom-16 -left-20 w-[440px] h-[440px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(127,29,29,0.18) 0%, transparent 62%)" }} />
      <div className="absolute top-0 left-1/4 w-[420px] h-[420px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(254,242,242,0.88) 0%, transparent 65%)" }} />
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          >
            ...
            <br />
            <em className="not-italic italic text-[#DC2626]">your school is simple</em>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {steps.map((s, i) => (
            ...
            >
              <div className="text-7xl font-extrabold text-[#DC2626]/15 mb-7 leading-none">{s.num}</div>
        ...
        >
          <Link
            href="/contact"
            className="inline-block bg-[#DC2626] text-white font-semibold px-12 py-5 rounded-full text-lg hover:bg-[#7F1D1D] transition-colors shadow-xl shadow-[#DC2626]/25"
          >

    ...
    <section id="get" className="relative pt-56 pb-36 px-6 lg:px-16 bg-[#FAFAF8]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(252,165,165,0.6) 0%, rgba(220,38,38,0.22) 42%, transparent 70%)" }}
        />
        <div
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(127,29,29,0.22) 0%, transparent 62%)" }}
        />
        <div
          className="absolute top-0 left-1/3 w-[350px] h-[350px] rounded-full"
          style={{ background: "radial-gradient(circle, rgba(254,242,242,0.9) 0%, transparent 65%)" }}
        />
      </div>

      {/* Fade into footer */}
      <div className="absolute bottom-0 inset-x-0 h-64 pointer-events-none z-0" style={{ background: "linear-gradient(to bottom, transparent 0%, #3B0808 100%)" }} />

      <div className="max-w-3xl mx-auto text-center relative z-10">

        <motion.p
          className="text-[#DC2626] font-semibold text-sm tracking-widest uppercase mb-7"
        ...
        >
          ...
          <Link
            href="/educators"
            className="px-10 py-4 rounded-full font-bold text-[#DC2626] text-base border-2 border-[#DC2626]/25 hover:border-[#DC2626]/60 hover:bg-white/60 transition-all duration-200"
          >
            For Educators →
          </Link>
        </motion.div>

...
export default function ResultsSlide() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen overflow-hidden bg-[#0d0620]">
      ...
      <div className="absolute top-0 inset-x-0 h-40 bg-gradient-to-b from-[#FAFAF8] to-transparent z-20 pointer-events-none" />
      <div className="absolute bottom-0 inset-x-0 h-40 bg-gradient-to-t from-white to-transparent z-20 pointer-events-none" />
